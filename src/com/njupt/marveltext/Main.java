...
public class Main extends Application{
	...
	public MenuBar getMenuBar() {
		...
		MenuItem saveAs =new MenuItem(" 另存为 (Ctrl + Shift + S )");
		...
		file.getItems().addAll(newTab, renameTab, saveAs, openFile, openDir);
	...
	public void saveTabHandler() {	
		//String savePath = Info.saveFilePath + "test.txt";
	}
	...
	public void showManual() {
		...
		//newTabHandler
		//import manual.md
		//rename("manual.md") not necessary
	}
}
